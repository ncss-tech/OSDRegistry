...
refresh_registry <- function() {
  ...
  latest.version <- available.versions$linux64[length(available.versions)] 
  rD <- RSelenium::rsDriver(browser = "chrome", chromever = latest.version,
                            geckover = NULL, iedrver = NULL,
